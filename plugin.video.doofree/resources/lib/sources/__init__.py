...
class sources:
    ...
    def sourcesFilter(self):
        ...
        hd_rank = ['afdah', 'directdlmovie', 'kisscartoon', 'adfly', 'thevideo', 'nosvideo','gvideo', 'vk', 'yify', 'uptobox', 'grifthost', 'vidto', 'kingfiles', 'streamin', 'uploadrocket', 'xfileload', 'nowvideo', 'cloudtime']
        sd_rank = hd_rank
