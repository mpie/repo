...
class navigator:
    ...
    def thaiLiveTV(self):
        ...
        self.addDirectoryItem('3HD', 'playThaiLiveTV&url=http://edge4-06.thaimediaserver.com/chlive3/live3stream_720p_20150924/playlist.m3u8&name=3HD&image=ch3hd.png', 'ch3hd.png', 'DefaultMovies.png', isFolder=False)
        ...
        self.addDirectoryItem('ONE', 'playThaiLiveTV&url=http://edge4-06.thaimediaserver.com/chliveGmmOne/liveGmmOnestream_20150924/playlist.m3u8&name=ONE_HD&image=ch1hd.png', 'ch1hd.png', 'DefaultMovies.png', isFolder=False)
        self.endDirectory()
