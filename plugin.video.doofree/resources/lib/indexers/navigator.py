...
class navigator:
    ...
    def root(self):
        self.addDirectoryItem('Movies', 'movieNavigator', 'root_movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('Series', 'tvNavigator', 'root_series.png', 'DefaultMovies.png')
        self.addDirectoryItem('Thai TV', 'thaiLiveTV', 'root_thaitv.png', 'DefaultMovies.png')
        self.addDirectoryItem('Thai shows', 'thaiShows', 'root_thaishows.png', 'DefaultMovies.png')
        self.addDirectoryItem('Thai shows alternative', 'thaiShows2', 'root_thaishows2.png', 'DefaultMovies.png')
    ...
    def thaiLiveTV(self):
        ...
        self.addDirectoryItem('3HD', 'playThaiLiveTV&url=http://edge4-04.thaimediaserver.com/chlive3/live3stream_720p_20150924/playlist.m3u8&name=3HD&image=ch3hd.png', 'ch3hd.png', 'DefaultMovies.png', isFolder=False)
        self.addDirectoryItem('3SD', 'playThaiLiveTV&url=http://edge4-03.thaimediaserver.com/chlive3sd/live3sd_20150924/playlist.m3u8&name=3SD&image=ch3sd.png', 'ch3sd.png', 'DefaultMovies.png', isFolder=False)
        ...
        self.addDirectoryItem('5HD', 'playThaiLiveTV&url=http://edge4-04.thaimediaserver.com/chlive5/live5stream_20150924/playlist.m3u8&name=5HD&image=ch5hd.png', 'ch5hd.png', 'DefaultMovies.png', isFolder=False)
